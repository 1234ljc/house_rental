...
export const regionData: Record<string, Record<string, string[]>> = {
  ...
  '河北省': {
    '石家庄市': ['长安区', '桥西区', '新华区', '井陉矿区', '裕华区', '藁城区', '鹿泉区', '栾城区', '正定县', '井陉县'],
    '唐山市': ['路南区', '路北区', '古冶区', '开平区', '丰南区', '丰润区', '曹妃甸区', '滦州市', '迁西县'],
    '秦皇岛市': ['海港区', '山海关区', '北戴河区', '抚宁区', '青龙县', '昌黎县', '卢龙县'],
    '邯郸市': ['邯山区', '丛台区', '复兴区', '峰峰矿区', '肥乡区', '永年区', '武安市'],
    '邢台市': ['襄都区', '信都区', '任泽区', '南和区', '沙河市', '临城县', '内丘县'],
    '保定市': ['竞秀区', '莲池区', '满城区', '清苑区', '徐水区', '涿州市', '定州市', '安国市', '高碑店市'],
    '张家口市': ['桥东区', '桥西区', '宣化区', '下花园区', '崇礼区', '张北县', '怀来县'],
    '承德市': ['双桥区', '双滦区', '鹰手营子矿区', '承德县', '兴隆县', '滦平县', '隆化县'],
    '沧州市': ['新华区', '运河区', '沧县', '青县', '东光县', '海兴县', '盐山县', '肃宁县', '黄骅市', '河间市'],
    '廊坊市': ['安次区', '广阳区', '固安县', '永清县', '香河县', '大城县', '文安县', '大厂县', '霸州市', '三河市'],
    '衡水市': ['桃城区', '冀州区', '枣强县', '武邑县', '武强县', '饶阳县', '安平县', '故城县', '深州市']
  },
  '山西省': {
    '太原市': ['小店区', '迎泽区', '杏花岭区', '尖草坪区', '万柏林区', '晋源区', '清徐县', '阳曲县', '古交市'],
    '大同市': ['新荣区', '平城区', '云冈区', '云州区', '阳高县', '天镇县', '广灵县', '灵丘县', '浑源县'],
    '阳泉市': ['城区', '矿区', '郊区', '平定县', '盂县'],
    '长治市': ['潞州区', '上党区', '屯留区', '潞城区', '襄垣县', '平顺县', '黎城县', '壶关县', '长子县'],
  ...
  '黑龙江省': {
    ...
    '伊春市': ['伊美区', '乌翠区', '友好区', '金林区', '铁力市', '嘉荫县', '汤旺县', '丰林县', '南岔县', '大箐山县'],
  ...
  '福建省': {
    ...
    '漳州市': ['芗城区', '龙文区', '龙海区', '云霄县', '漳浦县', '诏安县', '长泰区', '东山县', '南靖县', '平和县', '华安县'],
  ...
  '河南省': {
    ...
    '洛阳市': ['老城区', '西工区', '瀍河区', '涧西区', '吉利区', '洛龙区', '孟津区', '偃师区', '新安县', '栾川县', '嵩县', '汝阳县', '宜阳县', '洛宁县', '伊川县'],
  ...
  '湖南省': {
    ...
    '邵阳市': ['双清区', '大祥区', '北塔区', '新邵县', '邵阳县', '隆回县', '洞口县', '绥宁县', '新宁县', '城步县', '武冈市', '邵东市'],
    ...
    '永州市': ['零陵区', '冷水滩区', '东安县', '双牌县', '道县', '江永县', '宁远县', '蓝山县', '新田县', '江华县', '祁阳市'],
  ...
  '广西壮族自治区': {
    ...
    '桂林市': ['秀峰区', '叠彩区', '象山区', '七星区', '雁山区', '临桂区', '阳朔县', '灵川县', '全州县', '兴安县', '永福县', '灌阳县', '龙胜县', '资源县', '平乐县', '恭城县', '荔浦市'],
    ...
    '百色市': ['右江区', '田阳区', '田东县', '德保县', '那坡县', '凌云县', '乐业县', '田林县', '西林县', '隆林县', '靖西市', '平果市'],
  ...
  '四川省': {
    ...
    '凉山州': ['西昌市', '木里县', '盐源县', '德昌县', '会理市', '会东县', '宁南县', '普格县', '布拖县', '金阳县', '昭觉县', '喜德县', '冕宁县', '越西县', '甘洛县', '美姑县', '雷波县']
  },
  '贵州省': {
  ...
  '云南省': {
    ...
    '玉溪市': ['红塔区', '江川区', '通海县', '华宁县', '易门县', '峨山县', '新平县', '元江县', '澄江市'],
    ...
    '楚雄州': ['楚雄市', '双柏县', '牟定县', '南华县', '姚安县', '大姚县', '永仁县', '元谋县', '武定县', '禄丰市'],
  ...
  '台湾省': {
    ...
    '新北市': ['板桥区', '三重区', '中和区', '永和区', '新庄区', '新店区', '土城区', '芦洲区', '汐止区', '树林区', '�的莺歌区', '三峡区', '淡水区'],
    '桃园市': ['桃园区', '中�的壢区', '平镇区', '八德区', '杨梅区', '芦竹区', '�的潭区', '龟山区', '大溪区', '大园区', '观音区', '新屋区', '复兴区'],
    '台中市': ['中区', '东区', '南区', '西区', '北区', '北屯区', '西屯区', '南屯区', '太平区', '大里区', '雾峰区', '乌日区', '丰原区', '后里区', '潭子区', '大雅区', '神冈区', '大肚区', '沙鹿区', '龙井区', '梧栖区', '清水区', '大甲区', '外埔区', '大安区'],
    ...
    '高雄市': ['楠梓区', '左营区', '鼓山区', '三民区', '盐埕区', '前金区', '新兴区', '苓雅区', '前镇区', '旗津区', '小港区', '凤山区', '大寮区', '�的�的鸟松区', '仁武区', '大树区', '大社区', '冈山区', '路竹区', '桥头区', '梓官区', '弥陀区', '永安区', '燕巢区', '田寮区', '阿莲区', '茄萣区', '湖内区', '旗山区', '美浓区', '内门区', '杉林区', '甲仙区', '六龟区', '茂林区', '桃源区', '那玛夏区']
  },
  '香港特别行政区': {
...
export const provinceList = Object.keys(regionData)

export const getCityList = (province: string): string[] => {
  return province ? Object.keys(regionData[province] || {}) : []
}

export const getDistrictList = (province: string, city: string): string[] => {
  return province && city ? regionData[province]?.[city] || [] : []
}

// 根据城市名反查省份
export const getProvinceByCityName = (cityName: string): string => {
  for (const province of Object.keys(regionData)) {
    if (regionData[province][cityName]) {
      return province
    }
  }
  return ''
